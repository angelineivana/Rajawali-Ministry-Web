...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="faq-search">
                <input type="text" id="search-input" placeholder="Cari pertanyaan..." onkeyup="searchFAQ()">
            </div>
        </div>
    </section>
    ...
    <main>
        <section class="faq" id="faq">
            <?php foreach ($faqs as $faq): ?>
                <div class="faq-item">
                    <div class="faq-question" onclick="toggleAnswer(<?php echo $faq['id']; ?>)">
    ...
    <script>
        ...
        function toggleAnswer(id) {
            ...
            var faqItem = document.querySelector('.faq-item:nth-of-type(' + id + ')');
